...
// This Chinese Chess plugin reader should be placed in chineseChess

chess.pluginPaths.chineseChess = {
...
chess.pluginLoader.loadAllPlugins('js/chineseChess/plugins/', 
        chess.pluginPaths.chineseChess);
chess.pluginLoader.checkAllNeededPlugins(chess.plugins.chineseChess);

// Shows that this js files' loaded from its path
console.log('Loaded js file plugins.js from path js/chineseChess/');
//